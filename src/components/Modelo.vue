...
<nav class="menu">
  ...
  <ul>
    <li class="menu-item">
      <a class="fas fa-cat" @click=" Slider = true" href=""></a>
    </li>
    <li class="menu-item">
...
<script>
import JardimSlider from './JardimSlider.vue'
export default {
  name: 'Modelo',
  props: {
    imagens: JardimSlider,
    msg: String
  },
  components:{
    JardimSlider
...
body {
  overflow: hidden;
  background: rgb(212, 212, 223);
  background: linear-gradient(to right, rgb(51, 58, 58), rgb(78, 78, 94))
}
.menu-toggler {
  position: absolute;
  display: block;
